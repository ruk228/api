...
preferred | boolean | Является ли данный способ связи предпочитаемым (можно указать только один предпочитаемый контакт, в случае если preferred не передан, считаем, что передано значение `False`).
