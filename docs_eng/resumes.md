...
preferred | boolean | Is this the preferred method of communication (should mention only one preferred contact, if preferred flag is not sent default value for this parameter is `False`).
